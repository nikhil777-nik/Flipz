  ...
  return (
    <div className='flex items-center justify-between py-6 font-medium border-b border-slate-100/80 mb-6 relative z-30'>
      ...
      <Link to="/" className="flex items-center group cursor-pointer ml-4 sm:ml-8">
        <span className="font-heading text-xl sm:text-2xl font-extrabold text-slate-900 tracking-[0.18em] uppercase select-none group-hover:text-orange-500 transition-colors">
          FLIPZ
        </span>
      </Link>
